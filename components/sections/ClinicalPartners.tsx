    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="mb-10 max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-ink-muted">Our students rotate through four major hospitals from their first semester — not just in their final year.</p>
        </div>
